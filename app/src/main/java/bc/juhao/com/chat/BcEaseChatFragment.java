 ...
 */
public abstract class BcEaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    protected static final String TAG = "BcEaseChatFragment";
    ...
    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture, R.string.attach_order};
...
//            R.drawable.ease_chat_location_selector};
    ...
    private void hideView(View v) {
        ...
        ScaleAnimation sa = new ScaleAnimation(1, (float) v.getWidth()
                ...
                / ((View) v.getParent()).getHeight(), v.getX() + v.getWidth()
                / 2, v.getY() + v.getHeight() / 2);
        sa.setDuration(2000);
    ...
    public abstract void onSendOrder();
...
//                    startActivityForResult(new Intent(getActivity(), EaseBaiduMapActivity.class), REQUEST_CODE_MAP);
    ...
    protected BcEaseChatFragmentHelper chatFragmentHelper;

    public void setChatFragmentListener(BcEaseChatFragmentHelper chatFragmentHelper) {
        this.chatFragmentHelper = chatFragmentHelper;
    }

    public interface BcEaseChatFragmentHelper {
        /**
