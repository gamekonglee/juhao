    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(Constance.NEW_FRIENDS_USERNAME) || username.equals(Constance.GROUP_USERNAME)
                        || username.equals(Constance.CHAT_ROOM)|| username.equals(Constance.CHAT_ROBOT)) {
