...
public class GoodsInfo {
    ...
    private GoodsBean.App_img app_img;
    private int id;
    ...
    public void setApp_img(GoodsBean.App_img app_img) {
        this.app_img = app_img;
    }
    public GoodsBean.App_img getApp_img() {
        return app_img;
    }
    ...
    public void setPhotos(List<GoodsBean.Photos> photos) {
        this.photos = photos;
    }
    public List<GoodsBean.Photos> getPhotos() {
        return photos;
    }
