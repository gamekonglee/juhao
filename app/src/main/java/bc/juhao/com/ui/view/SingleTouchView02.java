 ...
 *
 */
public class SingleTouchView02 extends View {
	/**
	 * 图片的最大缩放比例
	 */
	...
	public SingleTouchView02(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SingleTouchView02(Context context) {
		this(context, null);
	}

	public SingleTouchView02(Context context, AttributeSet attrs, int defStyle) {
	...
	private void adjustLayout(){
		...
		FrameLayout.LayoutParams pa=new FrameLayout.LayoutParams(actualWidth, actualHeight);
		pa.gravity= Gravity.TOP|Gravity.LEFT; pa.leftMargin=newPaddingLeft;
		pa.topMargin=newPaddingTop;	setLayoutParams(pa);
