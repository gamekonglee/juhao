package bc.juhao.com.ui.view.search;
    ...
    private void init() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mListener.onTouchViewListener(name);
...
//                Toast.makeText(context, name, Toast.LENGTH_SHORT).show();
        ...
        topRightBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                String searchValue = et_search.getText().toString().trim();
                if (AppUtils.isEmpty(searchValue)){
                    MyToast.show(context,"请输入订单号!");
                    return;
                }

                boolean hasData = hasData(searchValue);
                if (!hasData) {
                    insertData(et_search.getText().toString().trim());

                    queryData("");
                }
                mListener.onTouchViewListener(searchValue);
//                Intent intent=new Intent(context, SearchOrderActivity.class);
//                intent.putExtra(Constance.SEARCH_ORDER,searchValue);
