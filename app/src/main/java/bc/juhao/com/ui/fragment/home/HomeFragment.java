...
//        ImageLoader.getInstance().displayImage(NetWorkConst.SCENE_HOST + "images/App/yijianpei.jpg", yijianpei);
    ...
    protected void initView() {
        ...
        lineIv = (ImageView) getView().findViewById(R.id.lineIv);
        ...
        one_ll = (LinearLayout) getView().findViewById(R.id.one_ll);
        two_ll = (LinearLayout) getView().findViewById(R.id.two_ll);
        three_ll = (LinearLayout) getView().findViewById(R.id.three_ll);
...
//                handleTitleBarColorEvaluate();
        ...
        refresh_view = (PullToRefreshLayout) getView().findViewById(R.id.refresh_view);
        kefu_rl = (RelativeLayout) getView().findViewById(R.id.kefu_rl);
        kefu_rl.setOnClickListener(this);

        xiandai_ll = (LinearLayout) getView().findViewById(R.id.keting_ll);
        yijia_ll = (LinearLayout) getView().findViewById(R.id.bieshu_ll);
        tianyuan_ll = (LinearLayout) getView().findViewById(R.id.louti_ll);
        zhongshi_ll = (LinearLayout) getView().findViewById(R.id.canting_ll);
        woshi_ll = (LinearLayout) getView().findViewById(R.id.woshi_ll);
        oushi_ll = (LinearLayout) getView().findViewById(R.id.shufang_ll);
        houxiandai_ll = (LinearLayout) getView().findViewById(R.id.ertongfang_ll);
        xinzhongshi_ll = (LinearLayout) getView().findViewById(R.id.weiyujian_ll);
        yangtai_ll = getView().findViewById(R.id.yangtai_ll);
        zoulang_ll = getView().findViewById(R.id.zoulang_ll);
        ll_jingxuan = getView().findViewById(R.id.ll_jingxuan);
        hsv_supermarket = getView().findViewById(R.id.hsv_supermarket);
        ...
        square_ll = (LinearLayout) getView().findViewById(R.id.square_ll);
        square_ll.setOnClickListener(this);
        add_rl = getView().findViewById(R.id.add_rl);
        add_rl.setOnClickListener(this);
        select_ll = (LinearLayout) getView().findViewById(R.id.select_ll);
        select_ll.setOnClickListener(this);
        my_works_ll = (LinearLayout) getView().findViewById(R.id.my_works_ll);
        ...
        keting_iv = (ImageView) getView().findViewById(R.id.keting_iv);
        woshi_iv = (ImageView) getView().findViewById(R.id.woshi_iv);
        ertong_iv = (ImageView) getView().findViewById(R.id.ertong_iv);
        guangyuan_iv = (ImageView) getView().findViewById(R.id.guangyuan_iv);
        canting_iv = (ImageView) getView().findViewById(R.id.canting_iv);
        gengduo_iv = (ImageView) getView().findViewById(R.id.gengduo_iv);
        yiji_iv = (ImageView) getView().findViewById(R.id.yiji_iv);
        ...
        rexiaotop_iv = (ImageView) getView().findViewById(R.id.rexiaotop_iv);
        pinpaitehui_iv = (ImageView) getView().findViewById(R.id.pinpaitehui_iv);
        maishoutuijian_iv = (ImageView) getView().findViewById(R.id.maishoutuijian_iv);
        rexiaotop_iv.setOnClickListener(this);
        pinpaitehui_iv.setOnClickListener(this);
        maishoutuijian_iv.setOnClickListener(this);
        yijianpei = (ImageView) getView().findViewById(R.id.yijianpei);
        yijianpei.setOnClickListener(this);

        zhongshi_iv = (ImageView) getView().findViewById(R.id.canting_home_iv);
        meishi_iv = (ImageView) getView().findViewById(R.id.meishi_iv);
        oushi_iv = (ImageView) getView().findViewById(R.id.shufang_home_iv);
        houxiandai_iv = (ImageView) getView().findViewById(R.id.ertongfang_iv);
        xinzhongshi_iv = (ImageView) getView().findViewById(keting_home_iv);
        yijia_iv = (ImageView) getView().findViewById(R.id.bieshu_iv);
        tianyuan_iv = (ImageView) getView().findViewById(R.id.louti_iv);

        popularity_01_iv = (ImageView) getView().findViewById(R.id.popularity_01_iv);
        popularity_02_iv = (ImageView) getView().findViewById(R.id.popularity_02_iv);
        popularity_03_iv = (ImageView) getView().findViewById(R.id.popularity_03_iv);
        popularity_01_iv.setOnClickListener(this);
        popularity_02_iv.setOnClickListener(this);
        popularity_03_iv.setOnClickListener(this);
        popularity_01_ll = (LinearLayout) getView().findViewById(R.id.popularity_01_ll);
        popularity_02_ll = (LinearLayout) getView().findViewById(R.id.popularity_02_ll);
        popularity_03_ll = (LinearLayout) getView().findViewById(R.id.popularity_03_ll);
