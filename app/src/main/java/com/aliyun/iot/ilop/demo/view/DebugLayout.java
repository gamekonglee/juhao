...
//                    if (TextUtils.isEmpty(bonePluginAPIDemo)) {
//                        Toast.makeText(v.getContext(), "bonePluginAPIDemo is empty", Toast.LENGTH_LONG).show();
//                        return;
//                    }
//
//                    Router.getInstance().toUrl(v.getContext(), bonePluginAPIDemo);
//                }
//            });
//            boneMobileSDK.addAction("组件列表", new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    if (TextUtils.isEmpty(bonePluginUIDemo)) {
//                        Toast.makeText(v.getContext(), "bonePluginUIDemo is empty", Toast.LENGTH_LONG).show();
//                        return;
//                    }
//
//                    Router.getInstance().toUrl(v.getContext(), bonePluginUIDemo);
//                }
//            });
            ...
            boneMobileSDK.addAction("本地调试", new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //IThingAction thingAction  = ThingSDK.getInstance().getThingsManager().getThingAction("rFxQZUvlQQtjdfXiXVQA0010596100");
                    //IThingCallListener listener = new IThingCallListener() {
                    //    @Override
                    //    public void onFailure(AError aError) {
                    //        ALog.e("APIGatewaySDKDelegate","zoro error = "+aError.getMsg());
                    //    }
                    //
                    //    @Override
                    //    public void onSuccess(JSONObject jsonObject) {
                    //        ALog.e("APIGatewaySDKDelegate","zoro succ = "+jsonObject.toString());
                    //    }
                    //};
                    //thingAction.getProperties(listener);
                    //thingAction.getStatus(listener);
                    //thingAction.getEvents(listener);

                    //BoneThing boneThing = new BoneThing();
                    //JSONObject jsonObject = new JSONObject();
                    //
                    //try {
                    //    jsonObject.put("iotId","rFxQZUvlQQtjdfXiXVQA0010596100");
                    //}catch (Exception e){
                    //}
                    //boneThing.subscribeChannelPush(jsonObject,null);
